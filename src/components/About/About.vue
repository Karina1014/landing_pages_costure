<template>
  <section id="sobreNosotros" class="w-full bg-[#FAF9FC] pt-12 pb-6 lg:pt-20 lg:pb-8 overflow-hidden relative animate-reveal-up">
    <!-- Decoración de fondo: Marca de agua sutil -->
    <div class="absolute top-10 right-[-5%] text-[15rem] font-black text-gray-100/50 select-none pointer-events-none font-serif italic font-medium leading-none">
      Entre Hilos & Agujas  
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
      <div class="flex flex-col lg:flex-row items-center gap-20 lg:gap-32">
        ...
        <div class="w-full lg:flex-1 flex flex-col items-start gap-8 order-1">
          ...
          <div class="relative bg-white/50 backdrop-blur-sm p-8 rounded-3xl border border-[#831378]/5 hover:border-[#831378]/10 transition-colors">
            <div class="absolute -top-3 -left-3 text-4xl text-[#831378]/20 font-serif italic font-black">"</div>
            <p class="text-gray-700 font-serif italic font-medium text-xl leading-relaxed relative z-10">
        ...
        <div class="w-full lg:w-[38%] relative group px-4 order-2">
          ...
          <div class="relative">
            ...
            <div class="absolute inset-0 border-2 border-dashed border-[#4294BD]/20 rounded-[2.5rem] rotate-3 group-hover:rotate-0 "></div>
            ...
            <div class="relative aspect-[4/5] rounded-[2rem] overflow-hidden shadow-[0_40px_80px_-15px_rgba(0,0,0,0.2)] bg-white z-10 transform -rotate-2 ">
              ...
              <!-- Efecto Lente/Brillo -->
              <div class="absolute inset-0 bg-gradient-to-tr from-[#4294BD]/20 via-transparent to-white/10 mix-blend-overlay"></div>
              ...
              <div class="absolute bottom-6 left-6 right-6 bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-xl transform translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 text-center">
                <p class="text-white font-bold text-sm tracking-tight font-serif italic font-medium">Arte en cada puntada</p>
              </div>
            </div>
            ...
            <div class="absolute -bottom-4 -right-4 w-16 h-16 bg-white rounded-full shadow-xl flex items-center justify-center z-20 border border-gray-100 animate-bounce-slow">
              <div class="w-10 h-10 rounded-full border border-dashed border-[#4294BD]/30 flex items-center justify-center">
                <Scissors class="w-5 h-5 text-[#4294BD] transform -rotate-45" />
              </div>
            </div>
          </div>
        </div>
